        ...
        <c:forEach items="${adoptions}" var="adoption">
            <tr>
                <td>
                    ...
                    <a href="${fn:escapeXml(adoptionUrl)}"><c:out value="${adoption.publishingOwner.firstName} ${adoption.publishingOwner.lastName}"/></a>
                </td>
                <td>
                    <c:out value="${adoption.publishingOwner.city}"/>
                </td>
                <td>
